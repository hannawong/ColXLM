...
from colXLM.utils.utils import print_message, flatten
from colXLM.retrieval.loaders import load_doclens
...
class FaissIndex():
    ...
    def queries_to_embedding_ids(self, faiss_depth, Q, verbose=True):
        ...
        print("#> Search in batches with faiss. \t\t Q.size() = ",Q.size(), "Q_faiss.size() = ",Q_faiss.size())
